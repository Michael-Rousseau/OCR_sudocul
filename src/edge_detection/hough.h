...
void get_sudoku_lines(struct Line *lines, int lineCount, struct Line *topLines,
                      int topCount);
...
// void print_h_v(struct Line* lines, int len, struct Line* horizon, struct
// Line* vertical, struct Line* topLinesh,struct Line* topLinesv);
